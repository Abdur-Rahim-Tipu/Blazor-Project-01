...
namespace CandidateBlazorApp.Shared.Models
{
    ...
    public class Candidate
    {
        ...
        public virtual List<Professional_Course>? Courses { get; set; } = new List<Professional_Course>();
    ...
    public class Professional_Course
    {
        [Key]
    ...
    public class CandidateDbContext : DbContext
    {
        ...
        public DbSet<Professional_Course> Courses { get; set; } = default!;
